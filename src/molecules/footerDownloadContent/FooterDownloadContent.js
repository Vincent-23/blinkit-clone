  ...
  return (
    <VerticalContainer className={classNames(styles.container, className)}>
      <HorizontalContainer className={classNames(styles.item, className)}>
        <Text className={classNames(styles.textContent, className)}>
          Download App
        </Text>
        <Image
          className={classNames(styles.imageItem, className)}
          image={"https://blinkit.com/d61019073b700ca49d22.png"}
        />
        <Image
          className={classNames(styles.imageItem, className)}
          image={"https://blinkit.com/8ed033800ea38f24c4f0.png"}
        />
      </HorizontalContainer>
    </VerticalContainer>
  );
...
FooterDownloadContent.propTypes = {
